...
/*Görev 1: macSkoru()
  ...
  // skor1 kodu skor değeri için closure kullanırken, skor2 kodunda bu yoktur.
  
  2. Hangisi bir closure kullanmaktadır? Nasıl tarif edebilirsin? (yarınki derste öğreneceksin :) )
  sko1 kodu closure kullanmaktadır.
  
  3. Hangi durumda skor1 tercih edilebilir? Hangi durumda skor2 daha mantıklıdır?
  skor'un kodun herhangi bir noktasında değişmesini istersek(fonksiyon dışından) skor2 değilse skor1 kullanmak mantıklıdır.
*/
